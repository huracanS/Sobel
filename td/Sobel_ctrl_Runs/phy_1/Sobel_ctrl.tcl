...
set rc [catch {
  ...
  import_db {../syn_1/Sobel_ctrl_gate.db}
  place
  export_db {Sobel_ctrl_place.db}
} RESULT]
if {$rc} {
...
set rc [catch {
  route
  report_area -io_info -file Sobel_ctrl_phy.area
  export_db {Sobel_ctrl_pr.db}
} RESULT]
if {$rc} {
...
set rc [catch {
  export_bid Sobel_ctrl_inst.bid
  bitgen -bit "Sobel_ctrl.bit"
} RESULT]
if {$rc} {
  step_error bitgen
  return -code error $RESULT
